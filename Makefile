#############################################################################
# Makefile for building: _bin/Git2Example
# Generated by qmake (3.1) (Qt 5.15.14)
# Project:  Git2Example.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Git2Example.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Git2Example1.0.0
DISTDIR = /home/soramimi/develop/Git2Example/.tmp/Git2Example1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Git2Example.pro  main.cpp
QMAKE_TARGET  = Git2Example
DESTDIR       = _bin/
TARGET        = _bin/Git2Example


first: all
####### Build rules

_bin/Git2Example:  $(OBJECTS)  
	@test -d _bin/ || mkdir -p _bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Git2Example.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Git2Example.pro
	$(QMAKE) -o Makefile Git2Example.pro
